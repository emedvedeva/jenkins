...
namespace TestProject1
{
    ...
    public class UnitTest1
    {
        ...
        public void TestMethod1()
        {
            ...
            Assert.Multiple(() =>
            {
                Assert.IsTrue(post.Title != null, "PostTitle is null");
                Assert.IsTrue(post.Body != null, "PostBody is null");
            });
            ...
            Assert.Multiple(() =>
            {
                Assert.AreEqual(generatedPost.Title, apipost.Title, "The titles are not match");
                Assert.AreEqual(generatedPost.Body, apipost.Body, "The Bodies are not match");
                Assert.AreEqual(generatedPost.UserId, apipost.UserId, "The UserIdes do not match");
            });
